    ...
    <>
      ...
      <section className='pt-[110px] pb-10 max-w-[660px] mx-auto bg-white'>
        <div className='w-[88.2667%] max-w-[460px] mx-auto'>
          <img src="/assets/PIONEX 로고.png" alt="PIONEX" className='w-20 h-20 mx-auto rounded-full' />
          <h1 className='text-2xl text-black text-center f-pretendard-b mt-[10px]'>Pionex</h1>
          <p className='text-[#7e7a7a] text-center f-pretendard-b mt-[10px] text-base'>그리드 봇⚡️⚡️</p>
          ...
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[10px] w-fit px-[10px] rounded-[30px] py-1'>함께 하는 회원   <span className='text-[#1aa0ee]'> 13명</span></p>
            ...
            <div className='max-w-[263px] mx-auto w-full'>
              ...
              <div className='mt-7 flex items-center'>
                ...
                <div className='ml-[15px]'>
                  ...
                  <p className='text-base text-black f-pretendard-b mt-[1px]'><span className='text-[#0789ec]'> VIP7 </span>  와 유사한 혜택이에요</p>
                </div>
              </div>
            </div>
          )}
              ...
              <ul>
                <li>
                  ...
                  <div className='mt-[14px] flex items-center p-[14px] bg-[#f0f2f5] rounded-xl justify-between'>
                    <div className='flex items-center'>
                      <img src="/assets/PIONEX 로고.png" alt="Pionex" className='w-7 h-7 block object-cover' />
                      <p className='ml-2 text-black text-lg f-pretendard-b'>Pionex</p>
                    </div>
                ...
                <li>
                  <div className='flex items-center mt-[18px]'>
                    ...
                    <div className='ml-[13px] flex-1'>
                      ...
                      <p className='text-base mt-[1px] text-black f-pretendard-b'>Pionex에서 KYC를 인증해주세요</p>
                    </div>
                  </div>
                </li>
                <li>
      ...
      <section className='pt-10 pb-[60px] max-w-[660px] mx-auto bg-white mt-5'>
        <div className=''>
          ...
          <div className='w-[88.2667%] max-w-[460px] mx-auto'>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              Pionex 일반 가입 계정 : 지정가 0.015% / 시장가 0.05%
            </div>
            <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
              테더락을 통해 가입 계정 : 지정가 0.008% / 시장가 0.02%
            </div>
          ...
          <div className='w-[93%] mx-auto pt-20'>
            ...
            <p className='mt-10 text-[#82879b] text-center f-pretendard-m text-[13px]'>이미 Pionex 계정이 있으신가요?</p>
