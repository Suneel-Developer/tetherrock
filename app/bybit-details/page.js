        ...
        <>
            ...
            <section className='pt-[110px] pb-10 max-w-[660px] mx-auto bg-white'>
                <div className='w-[88.2667%] max-w-[460px] mx-auto'>
                    <img src="/assets/bybit.png" alt="거래소 아이콘 로고" className='w-20 h-20 mx-auto rounded-full' />
                    <h1 className='text-2xl text-black text-center f-pretendard-b mt-[10px]'>Bybit</h1>
                    <p className='text-[#7e7a7a] text-center f-pretendard-b mt-[10px] text-base'>인기 거래소🔥</p>
                    <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[20px] w-fit px-[10px] rounded-[30px] py-1'>페이백 <span className='text-[#1aa0ee]'> 30%</span></p>
                    <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[10px] w-fit px-[10px] rounded-[30px] py-1'>함께 하는 회원   <span className='text-[#1aa0ee]'> 302명</span></p>


                    <div className='mt-[50px]'>
                        <div className='w-full h-[2px] bg-[#f0f2f5] relative'>
                            <div className='h-full bg-[#1aa0ee] w-[20%]'></div>
                            <div className='text-xs f-pretendard-m text-[#7c8389] bg-[#d9d9d9] w-fit rounded-[30px] px-2 absolute left-[50px] top-0 bottom-0 my-auto right-auto h-[25px] flex justify-center items-center'>
                                마감까지 34%
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='mt-7 flex justify-between'>
                        <div>
                            ...
                            <div className='mt-[6px] flex items-center'>
                                ...
                                <p className='text-[#0798ec] f-pretendard-sm text-sm tracking-[-0.56px] ml-5'>0.0112%</p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className='mt-[6px] flex items-center'>
                                <p className='text-[#bdbdc1] line-through f-pretendard-sm text-sm tracking-[-0.56px]'>0.02%</p>
                                <p className='text-[#0798ec] f-pretendard-sm text-sm tracking-[-0.56px] ml-5'>0.0308%</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className='pt-5 pb-20 max-w-[660px] mx-auto bg-white mt-5'>
                ...
                <p className='text-center text-xl f-pretendard-b text-[#4a4a4a]'>1인 평균 <span className='text-[#1aa0ee]'>122만원 </span>환급</p>
                ...
                <div className='w-[93.6%] mx-auto pt-[38px]'>
                        ...
                        <div className='max-w-[263px] mx-auto w-full'>
                            ...
                            <div className='mt-7 flex items-center'>
                                ...
                                <div className='ml-[15px]'>
                                    ...
                                    <p className='text-base text-black f-pretendard-b mt-[1px]'>수수료 <span className='text-[#0789ec]'> 30% </span> 를 페이백 해드려요</p>
                                </div>
                            </div>
                            <div className='mt-7 flex items-center'>
                                ...
                                <div className='ml-[15px]'>
                                    ...
                                    <p className='text-base text-black f-pretendard-b mt-[1px]'><span className='text-[#0789ec]'> VIP2 </span>  와 유사한 혜택이에요</p>
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        <div className='max-w-[263px] mx-auto w-full'>
                            <ul>
                                <li>
                                    ...
                                    <div className='mt-[14px] ml-5 flex items-center p-[14px] bg-[#f0f2f5] rounded-xl justify-between'>
                                        <div className='flex items-center'>
                                            <img src="/assets/bybit.png" alt="bybit" className='w-7 h-7 block object-cover' />
                                            <p className='ml-2 text-black text-lg f-pretendard-b'>Bybit</p>
                                        </div>
                                ...
                                <li>
                                    <div className='flex items-center mt-[18px]'>
                                        ...
                                        <div className='ml-[13px] flex-1'>
                                            ...
                                            <p className='text-base mt-[1px] text-black f-pretendard-b'>Bybit에서 KYC를 인증해주세요</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                    ...
                    {activeTab === 'event' && (
                        <div className='w-[93%] mx-auto grid grid-cols-2 slg:grid-cols-3 gap-2'>
                            <div>
                                <img src="/assets/event4.png" alt="bybit" className='w-[155px] h-[155px] rounded-2xl object-cover block' />
                                <p className='mt-1 text-[#212529] opacity-60 text-[13px] f-pretendard-m'>바이비트 신규회원 이벤트</p>
                                <p className='f-pretendard-b text-lg text-[#222222]'>30,000usdt</p>
                                <p className='leading-[20px] text-[13px] f-pretendard-r text-[#5c5d5f]'>24-06-01 ~ 24-06-30</p>
                            </div>
                            <div>
                                <img src="/assets/event5.png" alt="bybit" className='w-[155px] h-[155px] rounded-2xl object-cover block' />
                                <p className='mt-1 text-[#212529] opacity-60 text-[13px] f-pretendard-m'>바이비트 10만 usdt 럭키드로우</p>
                                <p className='f-pretendard-b text-lg text-[#222222]'>100,000 USDT</p>
                                <p className='leading-[20px] text-[13px] f-pretendard-r text-[#5c5d5f]'>24-05-23 ~ 24-06-30</p>
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className=''>
                    ...
                    <div className='w-[88.2667%] max-w-[460px] mx-auto'>
                        ...
                        <div className='text-[#424242] text-sm f-pretendard-b mt-12'>
                            플랫폼에서 조회가 안되더라도 가입한 이후 시점의 모든 거래 내역은
                        </div>

                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            페이백 대상이니 걱정하지 않으셔도 돼요.
                        </div>
                        <div className='text-[#424242] text-sm f-pretendard-b mt-12'>
                            페이백 대상 : 선물거래 / USDT 거래쌍
                        </div>

                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            BYBIT 일반 가입 계정 : 지정가 0.02% / 시장가 0.055%
                        </div>
                        <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
                            테더락을 통해 가입 계정 : 지정가 0.0112% / 시장가 0.0308%
                        </div>
                        ...
                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            일반 계정 : 수수료 100usdt (소멸되는 수수료)
                        </div>
                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            테더락 회원계정 :  선수수료 20%할인 80usdt(기간제)
                        </div>
                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            페이백 금액 80usdt의 30%인 24usdt 페이백
                        </div>
                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            30% 페이백 금액 테더락에서 지급
                        </div>
                        ...
                        <div className='text-[#424242] text-sm f-pretendard-b mt-12'>
                            매일 20시(<b className='text-[#ce0000]'>UTC 11:00</b>) 테더락 플랫폼에서 UID검색 환급금 조회, 신청이 가능합니다.
                        </div>
                        <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
                            단 이 과정에서 50USDT 이상일 경우에만 단 이 과정에서 50USDT 이상일 경우에만
                        </div>
                    </div>
                    ...
                    <div className='w-[93%] mx-auto pt-20'>
                        ...
                        <p className='mt-10 text-[#82879b] text-center f-pretendard-m text-[13px]'>이미 Bybit 계정이 있으신가요?</p>
