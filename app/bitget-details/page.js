    ...
    <>
      ...
      <section className='pt-[110px] pb-10 max-w-[660px] mx-auto bg-white'>
        <div className='w-[88.2667%] max-w-[460px] mx-auto'>
          <img src="/assets/bitget-exchange.png" alt="bitget" className='w-20 h-20 mx-auto rounded-full' />
          <h1 className='text-2xl text-black text-center f-pretendard-b mt-[10px]'>Bitget</h1>
          <p className='text-[#7e7a7a] text-center f-pretendard-b mt-[10px] text-base'>인기거래소🔥</p>
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[20px] w-fit px-[10px] rounded-[30px] py-1'>페이백 <span className='text-[#1aa0ee]'> 50%</span></p>
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[10px] w-fit px-[10px] rounded-[30px] py-1'>함께 하는 회원   <span className='text-[#1aa0ee]'> 288명</span></p>
          ...
          <div className='mt-7 flex justify-between'>
            <div>
              ...
              <div className='mt-[6px] flex items-center'>
                <p className='text-[#bdbdc1] line-through f-pretendard-sm text-sm tracking-[-0.56px]'>0.01%</p>
            ...
            <div>
              ...
              <div className='mt-[6px] flex items-center'>
                ...
                <p className='text-[#0798ec] f-pretendard-sm text-sm tracking-[-0.56px] ml-5'>0.02%</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className='pt-5 pb-20 max-w-[660px] mx-auto bg-white mt-5'>
        ...
        <p className='text-center text-xl f-pretendard-b text-[#4a4a4a]'>1인 평균  <span className='text-[#1aa0ee]'> 134만원 </span>환급</p>
        ...
        <div className='w-[93.6%] mx-auto pt-[38px]'>
          {activeTab === 'info' && (
            <div className='max-w-[263px] mx-auto w-full'>
              ...
              <h1 className='text-center text-xl f-pretendard-b'>높은 페이백 조건을 확인하고
                <br />
                수수료 부담을 줄여요</h1>
              ...
              <div className='mt-7 flex items-center'>
                ...
                <div className='ml-[15px]'>
                  ...
                  <p className='text-base text-black f-pretendard-b mt-[1px]'>수수료 <span className='text-[#0789ec]'> 50% </span> 를 페이백 해드려요</p>
                </div>
              </div>
              <div className='mt-7 flex items-center'>
                ...
                <div className='ml-[15px]'>
                  ...
                  <p className='text-base text-black f-pretendard-b mt-[1px]'><span className='text-[#0789ec]'> VIP4 </span>  와 유사한 혜택이에요</p>
                </div>
              </div>
            </div>
          )}
              ...
              <ul>
                <li>
                  ...
                  <div className='mt-[14px] ml-5 flex items-center p-[14px] bg-[#f0f2f5] rounded-xl justify-between'>
                    <div className='flex items-center'>
                      <img src="/assets/bitget-exchange.png" alt="bitget" className='w-7 h-7 block object-cover' />
                      <p className='ml-2 text-black text-lg f-pretendard-b'>Bitget</p>
                    </div>
                ...
                <li>
                  <div className='flex items-center mt-[18px]'>
                    ...
                    <div className='ml-[13px] flex-1'>
                      ...
                      <p className='text-base mt-[1px] text-black f-pretendard-b'>Bitget에서 KYC를 인증해주세요</p>
                    </div>
                  </div>
                </li>
                <li>
      ...
      <section className='pt-10 pb-[60px] max-w-[660px] mx-auto bg-white mt-5'>
        <div className=''>
          ...
          <div className='w-[88.2667%] max-w-[460px] mx-auto'>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
            BITGET 일반 가입 계정 : 지정가 0.02% / 시장가 0.04%
            </div>
            <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
            테더락을 통해 가입 계정 : 지정가 0.01% / 시장가 0.02%
            </div>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
            페이백 금액 100usdt의 50%인 50usdt 페이백
            </div>
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
            50% 페이백 금액은 테더락 플랫폼에서 지급
            </div>
          ...
          <div className='w-[93%] mx-auto pt-20'>
            ...
            <p className='mt-10 text-[#82879b] text-center f-pretendard-m text-[13px]'>이미 Bitget 계정이 있으신가요?</p>
