...
const Navbar = () => {
    ...
    return (
        <header className='py-[18px] slg:py-5 bg-[#0a1012] fixed top-0 z-50 w-full'>
            <div className='max-w-[660px] slg:max-w-[1100px] m-auto w-[88.266666%]'>
                <div className='flex justify-between items-center w-full'>
                    <div className='block slg:hidden' onClick={handleMenuToggle}>
                        <img
                            src={menuOpen ? "/assets/service_header_close.png" : "/assets/service_header_menu.png"}
                            alt="menu"
                    ...
                    <div className='block'>
                        <Link href='/' className=''>
                            <img src="/assets/service_header_logo.png" alt="Tetherrock" className='w-[158px]' />
                        </Link>
                    </div>
                    ...
                    {/* Mobile Links  */}
                    {menuOpen && (
                        <div className={`block slg:hidden fixed top-0 left-0 right-0 w-full h-screen bg-[#0a1012] z-[-2] ${menuClass}`}>
                    ...
                    <div className='flex slg:ml-10 relative items-center'>
                        ...
                        <div className='slg:ml-5 relative'>
                            <button className='flex justify-center items-center cursor-pointer' onClick={handleTransletorMenuToggle}>
                                <img src="/assets/language_white.svg" alt="언어설정 버튼" className='w-[18px] slg:w-6 h-[18px] slg:h-6' />
                            </button>
