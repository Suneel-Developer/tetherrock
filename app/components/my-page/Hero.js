    ...
    return (
        <section className='mt-20'>
            <div className='max-w-[660px] px-4 mx-auto pt-10 slg:pt-[60px] pb-10 slg:pb-[68px] w-full bg-[#1aa0ee]'>
                <div>
                    <p className="text-xl f-pretendard-b text-white text-center">24. 6. 20 </p>
                    <p className="text-[32px] slg:text-[42px] mt-5 f-pretendard-b leading-[26px] text-white text-center">0.00 USDT</p>
                    <p className="text-sm mt-6 f-pretendard-m opacity-70 text-white text-center">The criteria for updating are different for each exchange.</p>
                </div>
            </div>
