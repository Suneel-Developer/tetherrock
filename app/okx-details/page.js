    ...
    <>
      ...
      <section className='pt-[110px] pb-10 max-w-[660px] mx-auto bg-white'>
        <div className='w-[88.2667%] max-w-[460px] mx-auto'>
          <img src="/assets/okx-exchange.png" alt="OKX" className='w-20 h-20 mx-auto rounded-full' />
          <h1 className='text-2xl text-black text-center f-pretendard-b mt-[10px]'>OKX</h1>
          ...
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[10px] w-fit px-[10px] rounded-[30px] py-1'>함께 하는 회원   <span className='text-[#1aa0ee]'> 88명</span></p>
      ...
      <section className='pt-5 pb-20 max-w-[660px] mx-auto bg-white mt-5'>
        ...
        <p className='text-center text-xl f-pretendard-b text-[#4a4a4a]'>1인 평균 <span className='text-[#1aa0ee]'>98만원 </span>환급</p>
        ...
        <div className='w-[93.6%] mx-auto pt-[38px]'>
              ...
              <ul>
                <li>
                  ...
                  <div className='mt-[14px] flex items-center p-[14px] bg-[#f0f2f5] rounded-xl justify-between'>
                    <div className='flex items-center'>
                      <img src="/assets/okx-exchange.png" alt="okx" className='w-7 h-7 block object-cover' />
                      <p className='ml-2 text-black text-lg f-pretendard-b'>OKX</p>
                    </div>
                ...
                <li>
                  <div className='flex items-center mt-[18px]'>
                    ...
                    <div className='ml-[13px] flex-1'>
                      ...
                      <p className='text-base mt-[1px] text-black f-pretendard-b'>OKX에서 KYC를 인증해주세요</p>
                    </div>
                  </div>
                </li>
                <li>
          ...
          {activeTab === 'event' && (
            <div className='w-[93%] mx-auto grid grid-cols-2 slg:grid-cols-3 gap-2'>
              <div>
                <img src="/assets/event2.png" alt="bingx" className='w-[155px] h-[155px] rounded-2xl object-cover block' />
                <p className='mt-1 text-[#212529] opacity-60 text-[13px] f-pretendard-m'>OKX 6월 이벤트</p>
                <p className='f-pretendard-b text-lg text-[#222222]'>1000USDT</p>
                <p className='leading-[20px] text-[13px] f-pretendard-r text-[#5c5d5f]'>24-05-24 ~ 24-06-23</p>
              </div>
              <div>
                <img src="/assets/event3.png" alt="bingx" className='w-[155px] h-[155px] rounded-2xl object-cover block' />
                <p className='mt-1 text-[#212529] opacity-60 text-[13px] f-pretendard-m'>OKX 6월 신규회원 이벤트</p>
                <p className='f-pretendard-b text-lg text-[#222222]'>60,000USDT</p>
      ...
      <section className='pt-10 pb-[60px] max-w-[660px] mx-auto bg-white mt-5'>
        <div className=''>
          ...
          <div className='w-[88.2667%] max-w-[460px] mx-auto'>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              OKX 일반 가입 계정 : 지정가 0.02% / 시장가 0.05%
            </div>
            <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
              테더락을 통해 가입 계정 : 지정가 0.01% / 시장가 0.025%
            </div>
          ...
          <div className='w-[93%] mx-auto pt-20'>
            ...
            <p className='mt-10 text-[#82879b] text-center f-pretendard-m text-[13px]'>이미 OKX 계정이 있으신가요?</p>
