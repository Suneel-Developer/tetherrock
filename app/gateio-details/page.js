    ...
    <>
      ...
      <section className='pt-[110px] pb-10 max-w-[660px] mx-auto bg-white'>
        <div className='w-[88.2667%] max-w-[460px] mx-auto'>
          <img src="/assets/gateio-exchange.png" alt="Gateio" className='w-20 h-20 mx-auto rounded-full' />
          <h1 className='text-2xl text-black text-center f-pretendard-b mt-[10px]'>Gateio</h1>
          <p className='text-[#7e7a7a] text-center f-pretendard-b mt-[10px] text-base'>신규거래소💰</p>
          ...
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[10px] w-fit px-[10px] rounded-[30px] py-1'>함께 하는 회원   <span className='text-[#1aa0ee]'> 79명</span></p>
      ...
      <section className='pt-5 pb-20 max-w-[660px] mx-auto bg-white mt-5'>
        ...
        <p className='text-center text-xl f-pretendard-b text-[#4a4a4a]'>1인 평균 <span className='text-[#1aa0ee]'>149만원 </span>환급</p>
              ...
              <ul>
                <li>
                  ...
                  <div className='mt-[14px] ml-5 flex items-center p-[14px] bg-[#f0f2f5] rounded-xl justify-between'>
                    <div className='flex items-center'>
                      <img src="/assets/gateio-exchange.png" alt="gateio" className='w-7 h-7 block object-cover' />
                      <p className='ml-2 text-black text-lg f-pretendard-b'>Gateio</p>
                    </div>
                ...
                <li>
                  <div className='flex items-center mt-[18px]'>
                    ...
                    <div className='ml-[13px] flex-1'>
                      ...
                      <p className='text-base mt-[1px] text-black f-pretendard-b'>Gateio에서 KYC를 인증해주세요</p>
                    </div>
                  </div>
                </li>
                <li>
      ...
      <section className='pt-10 pb-[60px] max-w-[660px] mx-auto bg-white mt-5'>
        <div className=''>
          ...
          <div className='w-[88.2667%] max-w-[460px] mx-auto'>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              gate.io 일반 가입 계정 : 지정가 0.015% / 시장가 0.05%
            </div>
            <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
              테더락을 통해 가입 계정 : 지정가 0.006% / 시장가 0.02%
            </div>
          ...
          <div className='w-[93%] mx-auto pt-20'>
            ...
            <p className='mt-10 text-[#82879b] text-center f-pretendard-m text-[13px]'>이미 Gateio 계정이 있으신가요?</p>
