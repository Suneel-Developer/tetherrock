    ...
    <>
      ...
      <section className='pt-[110px] pb-10 max-w-[660px] mx-auto bg-white'>
        <div className='w-[88.2667%] max-w-[460px] mx-auto'>
          <img src="/assets/Bingx.png" alt="Bingx" className='w-20 h-20 mx-auto rounded-full' />
          <h1 className='text-2xl text-black text-center f-pretendard-b mt-[10px]'>Bingx</h1>
          <p className='text-[#7e7a7a] text-center f-pretendard-b mt-[10px] text-base'>인기거래소🚀</p>
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[20px] w-fit px-[10px] rounded-[30px] py-1'>페이백 <span className='text-[#1aa0ee]'> 60%</span></p>
          <p className='bg-[#f0f2f5] text-sm f-pretendard-m mx-auto mt-[10px] w-fit px-[10px] rounded-[30px] py-1'>함께 하는 회원   <span className='text-[#1aa0ee]'> 420명</span></p>
          ...
          <div className='mt-7 flex justify-between'>
            ...
            <div>
              ...
              <div className='mt-[6px] flex items-center'>
                ...
                <p className='text-[#0798ec] f-pretendard-sm text-sm tracking-[-0.56px] ml-5'>0.012%</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className='pt-5 pb-20 max-w-[660px] mx-auto bg-white mt-5'>
        ...
        <p className='text-center text-xl f-pretendard-b text-[#4a4a4a]'>1인 평균 <span className='text-[#1aa0ee]'>138만원 </span>환급</p>
        ...
        <div className='w-[93.6%] mx-auto pt-[38px]'>
            ...
            <div className='max-w-[263px] mx-auto w-full'>
              ...
              <div className='mt-7 flex items-center'>
                ...
                <div className='ml-[15px]'>
                  ...
                  <p className='text-base text-black f-pretendard-b mt-[1px]'>수수료 <span className='text-[#0789ec]'> 60% </span> 를 페이백 해드려요</p>
                </div>
              </div>
              <div className='mt-7 flex items-center'>
              ...
              <ul>
                <li>
                  ...
                  <div className='mt-[14px] flex items-center p-[14px] bg-[#f0f2f5] rounded-xl justify-between'>
                    <div className='flex items-center'>
                      <img src="/assets/Bingx.png" alt="Bingx" className='w-7 h-7 block object-cover' />
                      <p className='ml-2 text-black text-lg f-pretendard-b'>Bingx</p>
                    </div>
                ...
                <li>
                  <div className='flex items-center mt-[18px]'>
                    ...
                    <div className='ml-[13px] flex-1'>
                      ...
                      <p className='text-base mt-[1px] text-black f-pretendard-b'>Bingx에서 KYC를 인증해주세요</p>
                    </div>
                  </div>
                </li>
                <li>
          ...
          {activeTab === 'event' && (
            <div className='w-[93%] mx-auto grid grid-cols-2 slg:grid-cols-3 gap-2'>
              <div>
                <img src="/assets/event1.png" alt="bingx" className='w-[155px] h-[155px] rounded-2xl object-cover block' />
                <p className='mt-1 text-[#212529] opacity-60 text-[13px] f-pretendard-m'>빙엑스 6월 신규회원 이벤트</p>
                <p className='f-pretendard-b text-lg text-[#222222]'>6750+20M PEPE</p>
      ...
      <section className='pt-10 pb-[60px] max-w-[660px] mx-auto bg-white mt-5'>
        <div className=''>
          ...
          <div className='w-[88.2667%] max-w-[460px] mx-auto'>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              BingX 일반 가입 계정 : 지정가 0.02% / 시장가 0.05%
            </div>
            <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
              테더락을 통해 가입 계정 : 지정가 0.0064% / 시장가 0.016%
            </div>
            <div className='text-[#085294] text-sm f-pretendard-b mt-3'>
              (거래수수료 60% 페이백 + 수수료20% 할인)
            </div>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              테더락 회원계정 :  수수료 20%할인 적용시 80usdt,
            </div>
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              페이백 금액 100usdt의 60%인 60usdt 페이백
            </div>
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              실제 소요 수수료 32usdt
            </div>
            ...
            <div className='text-[#424242] text-sm f-pretendard-b mt-12'>
              매일 20시 (UTC 11:00) 테더락 플랫폼에서
            </div>
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              UID검색 환급금 조회, 신청이 가능합니다.
            </div>
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              단 이 과정에서 50USDT 이상일 경우에만
            </div>
            <div className='text-[#424242] text-sm f-pretendard-b mt-3'>
              출금이 가능합니다.
            </div>
          ...
          <div className='w-[93%] mx-auto pt-20'>
            ...
            <p className='mt-10 text-[#82879b] text-center f-pretendard-m text-[13px]'>이미 BingX 계정이 있으신가요?</p>
